...
export default function Project({title, description, tags, imageUrl,linkUrl}: ProjectProps) {
    ...
    return (
      ...
      flex flex-col h-full sm:group-even:ml-[18rem]">
                ...
                <p className=" pr-3 mt-2 leading-relaxed text-gray-700 dark:text-white/70">{description}</p>
