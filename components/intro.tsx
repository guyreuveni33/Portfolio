        ...
        <section ref={ref} className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]"
            ...
            <div className="flex items-center justify-center">
                <div className="relative">
                    ...
                    >
                        <Image
                            src="https://i.postimg.cc/mrrgWtYM/0.jpg"
                            alt="Guy Reuveni"
                            width="192"
                            height="192"
                            quality="95"
                            priority={true}
                            className="h-24 w-24 rounded-full object-cover border-[0.35rem] border-white shoadow-xl"
                        />
            ...
            <motion.p className="mg--10 m-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl"
